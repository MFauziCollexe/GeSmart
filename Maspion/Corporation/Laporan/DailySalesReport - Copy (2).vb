...
Public Class DailySalesReport
    ...
    Private Sub InitializeComponent()
        ...
        Me.XtraScrollableControl1.Size = New System.Drawing.Size(390, 357)
        ...
        'BtnView
        '
        Me.BtnView.Location = New System.Drawing.Point(97, 364)
    ...
    IIf(TxtKodeGudang.Text = "", "", " AND NOTA.GUDANG='" & TxtKodeGudang.Text & "' ") & promo & " ) A LEFT JOIN LINK_BARANG_PROMO LBP ON A.ID_BARANG=LBP.ID_BARANG AND CONVERT(DATE,'" & DtTanggalAwal.DateTime & "',103) >= CONVERT(DATE,LBP.TGL_AWAL,103) AND CONVERT(DATE,'" & DtTanggalAkhir.DateTime & "',103) <= CONVERT(DATE,LBP.TGL_AKHIR,103)) Z ORDER BY Z.NAMA_DIVISI,Z.TGL_PENGAKUAN,Z.NAMA_GUDANG,CAST(RIGHT(Z.NO_NOTA, 6) AS INT) ")
