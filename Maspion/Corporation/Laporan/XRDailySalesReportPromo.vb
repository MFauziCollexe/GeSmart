...
Public Class XRDailySalesReportPromo
    ...
    Private Sub AddDisc_GetValue(sender As Object, e As DevExpress.XtraReports.UI.GetValueEventArgs) Handles AddDisc.GetValue
        ...
        e.Value = Convert.ToDouble(GetCurrentColumnValue("DISC_QTY")).ToString("n0") &
                "+" & Convert.ToDouble(GetCurrentColumnValue("DISC_1")).ToString("n0") &
                "+" & Convert.ToDouble(GetCurrentColumnValue("DISC_2")).ToString("n0") &
                "+" & Convert.ToDouble(GetCurrentColumnValue("DISC_3")).ToString("n0") &
