Public MustInherit Class FrmKaryawan
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        If ToolStripButton1.Visible = False Then Exit Sub
        ShowDevexpressReport(ReportPreview.KeyReport.QRCodeUser, TxtKode.Text)
        Log.Cetak(Me, TxtKode.Text)
...
Public Class InputKaryawan
    ...
    Private Sub _Toolbar1_Button1_Click(sender As System.Object, e As System.EventArgs) Handles _Toolbar1_Button1.Click
        ...
        SQl = ("INSERT INTO [USERS] VALUES ('" & TxtKode.Text & "','" & TxtNama.Text & "','" & TxtNIK.Text & "','" & txtAlamatKantor.Text & "','" & TxtTelp.Text & "','" & txtKota.Text & "','" & Format(Dt1.EditValue, "MM/dd/yyyy") & "','" & RdKelamin.EditValue & "','" & RdStatus.EditValue & "','" & CmbAgama.SelectedItem & "','" & Format(DTpo.EditValue, "MM/dd/yyyy") & "','" & CmbDepartemen.SelectedItem & "','" & cmbJabatan.SelectedItem & "','" & txtKeterangan.Text & "','" & TxtPenanggungJawab1.Text & "','" & TxtPenanggungJawab2.Text & "','" & ChkUser.Checked & "','" & SmartEngine.encrypt(Txtpass.Text) & "','" & Split(CmbIDGroup.SelectedItem, "-")(0) & "','" & ChkRubahHarga.Checked & "','" & ChkOtorisasi.Checked & "','" & txtOtorisasi.Text & "','" & ChkPeriode.Checked & "','True','" & UserID & "',CURRENT_TIMESTAMP,NULL,NULL)")
...
Public Class EditKaryawan
    ...
    Private Sub GetData()
        LoadData.GetData("SELECT NAMA_USER, NIK, ALAMAT, TELP, KOTA, KELAMIN, STATUS_NIKAH, AGAMA, TGL_LAHIR, TGL_MASUK, DEPARTEMEN, JABATAN, KETERANGAN, EMAIL_PJ1, EMAIL_PJ2, PASSWORD, PASSWORD, ID_GROUP, HAK_HARGA, HAK_PERIODE, HAK_OTORISASI, PASSWORD_OTORISASI, HAK_USER, STATUS_AKTIF  FROM USERS WHERE ID_USER = '" & TxtKode.Text & "'")
        LoadData.SetData({TxtNama, TxtNIK, txtAlamatKantor, TxtTelp, txtKota, RdKelamin, RdStatus, CmbAgama, Dt1, DTpo, CmbDepartemen, cmbJabatan, txtKeterangan, TxtPenanggungJawab1, TxtPenanggungJawab2, Txtpass, TxtPass2, CmbIDGroup, ChkRubahHarga, ChkPeriode, ChkOtorisasi, txtOtorisasi, ChkUser, CkAktif})
