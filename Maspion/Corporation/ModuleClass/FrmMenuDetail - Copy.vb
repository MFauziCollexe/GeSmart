...
Public MustInherit Class FrmMenuDetail
    ...
    Private Sub GridView1_CustomDrawCell(sender As Object, e As DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs) Handles GridView1.CustomDrawCell
        ...
        '            Using mydt As DataTable =
        '                SelectCon.execute("SELECT SUM(PCS_T) TERPENUHI FROM V_D_DB_PERW_T_STUFF WITH (NOLOCK) WHERE ID_TRANSAKSI='" &
        ...
        If e.RowHandle >= 0 Then
            If e.Column Is GridView1.Columns(0) Then
                If SelectCon.execute("SELECT * FROM CLOSING_TRANSAKSI WITH (NOLOCK) WHERE ID_TRANSAKSI='" & GridView1.GetDataRow(e.RowHandle).Item(0) & "'").Rows.Count > 0 Then
    ...
    Private Sub GridView1_BeforePrintRow(sender As Object, e As CancelPrintRowEventArgs) Handles GridView1.BeforePrintRow
