        ...
        Public Sub EndInit(ByRef GridControl As DevExpress.XtraGrid.GridControl, ByRef Gridview As DevExpress.XtraGrid.Views.Grid.GridView)
            ...
            If Gridview.Columns.Count > 0 Then
                ...
                For Each e As ConfGrid In LstConfGrid
                    If i <= Gridview.Columns.Count - 1 Then
...
#End Region
    ...
    Public Function Terbilang(ByVal x As Double) As String
        x = Math.Round(x, 2)
        Dim number = x.ToString.Replace(",", ".").Split(".")
        Terbilang = DepanKoma(number(0))
        If number.Length > 1 Then
            Terbilang &= "Koma " & GetTens(number(1))
        End If

        Terbilang &= " Rupiah"
    End Function

    Public Function DepanKoma(ByVal x As Double) As String
