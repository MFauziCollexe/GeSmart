...
#End Region
    ...
    Private Sub TxtIDNota_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles TxtIDNota.EditValueChanged
        If Status_Edit = False Then
            LoadData.GetData("SELECT NO_NOTA,TGL_PENGAKUAN,DIVISI,JENIS_PPN,KODE_EKSPEDISI,NO_TRUK,GUDANG,DISC_QTY,DISC_REG,DISC_1,DISC_2,DISC_3,CASH_DISC,DISC_QTY1 FROM PEMBELIAN WITH (NOLOCK) WHERE ID_TRANSAKSI='" & TxtIDNota.Text & "'")
