Public Class FrmPencarianTransaksi
            ...
            If GridView1.RowCount > 0 Then
                Select Case Key
                    Case KeyPencarian.Transaksi_Purchase_Order
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.ID_BARANG,B.KODE,B.NAMA,A.SATUAN,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.PCS-A.PCS_T,A.DISC,A.DISKON_SATUAN FROM V_D_PO_T_DO A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                    ...
                    Case KeyPencarian.Transaksi_DO_BON_Perwakilan
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN,B.KODE,B.NAMA,A.KOLI-A.KOLI_T AS KOLI,A.QUANTITY-A.QUANTITY_T AS QTY,A.SATUAN,A.PCS-A.PCS_T AS PCS FROM V_D_DB_PERW_T_STUFF A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                    ...
                    Case KeyPencarian.Transaksi_Nota_Pembelian
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN,B.KODE,B.NAMA,A.SATUAN,A.KOLI_NOTA,A.QTY_NOTA,A.PCS_NOTA,A.KOLI_CLAIM,A.QTY_CLAIM,A.PCS_CLAIM FROM V_D_PB_T_CLAIM A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                    ...
                    Case KeyPencarian.Transaksi_Nota_Perwakilan
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT B.KODE,B.NAMA,A.SATUAN,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.PCS-A.PCS_T FROM V_D_NOTA_T_SJ A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' ORDER BY URUTAN")
                    ...
                    Case KeyPencarian.Transaksi_Stuffing
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT B.KODE,B.NAMA,A.SATUAN,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.PCS-A.PCS_T FROM V_D_STUFF_T_NOTA A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' ORDER BY URUTAN")
                            LoadDataToGrid.Init("Kode Barang", 15)
                            LoadDataToGrid.Init("Nama Barang", 150)
                            LoadDataToGrid.Init("Satuan", 30)
                            LoadDataToGrid.Init("Koli", 40, DevExpress.Utils.FormatType.Numeric, "n")
                    ...
                    Case KeyPencarian.Transaksi_DO_BON_Pusat
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN,B.KODE,B.NAMA,A.KOLI-A.KOLI_T AS KOLI,A.QUANTITY-A.QUANTITY_T AS QTY,A.SATUAN,A.PCS-A.PCS_T AS PCS FROM V_D_DB_PUSAT_T_NOTA A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                            LoadDataToGrid.Init("No.", 15)
                            LoadDataToGrid.Init("Kode Barang", 50)
                            LoadDataToGrid.Init("Nama Barang", 150)
                            LoadDataToGrid.Init("Koli", 40, DevExpress.Utils.FormatType.Numeric, "n")
                    ...
                    Case KeyPencarian.Transaksi_TTB
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN,B.KODE,B.NAMA,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.SATUAN,A.PCS-A.PCS_T FROM V_D_TTB_T_RJ A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                            LoadDataToGrid.Init("No.", 15)
                            LoadDataToGrid.Init("Kode Barang", 50)
                            LoadDataToGrid.Init("Nama Barang", 150)
                            LoadDataToGrid.Init("Koli", 40, DevExpress.Utils.FormatType.Numeric, "n")
                    ...
                    Case KeyPencarian.Transaksi_Nota_Titip_Barang
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.ID_BARANG,B.KODE,B.NAMA,A.SATUAN,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.PCS-A.PCS_T,A.HARGA FROM V_D_NOTA_T_TITIP A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                    ...
                    Case KeyPencarian.Transaksi_Titip_Barang
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.ID_BARANG,B.KODE,B.NAMA,A.SATUAN,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.PCS-A.PCS_T,A.HARGA FROM V_D_TITIP_T_SJ A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                            LoadDataToGrid.Init("ID", 15, , , False)
                            LoadDataToGrid.Init("Kode Barang", 50)
                            LoadDataToGrid.Init("Nama Barang", 150)
                            LoadDataToGrid.Init("Satuan", 30)
                    ...
                    Case KeyPencarian.Transaksi_Transfer_Gudang
                        TBDetailCari.DataSource = SelectCon.execute("SELECT A.ID_BARANG,B.KODE,B.NAMA,A.QUANTITY-A.QUANTITY_T,A.SATUAN FROM V_D_TRANSFER_T_TERIMA A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ")
                        GridView2.Columns(0).Caption = "ID Barang"
                        GridView2.Columns(0).Width = 35
                        GridView2.Columns(1).Caption = "Kode Barang"
                        GridView2.Columns(1).Width = 50
                    ...
                    Case KeyPencarian.Transaksi_TTB_Retur_Pembelian
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN,B.KODE,B.NAMA,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.SATUAN,A.PCS-A.PCS_T FROM V_D_TTB_T_RB_N_TBR A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                            LoadDataToGrid.Init("No.", 15)
                            LoadDataToGrid.Init("Kode Barang", 50)
                            LoadDataToGrid.Init("Nama Barang", 150)
                            LoadDataToGrid.Init("Koli", 40, DevExpress.Utils.FormatType.Numeric, "n")
                    ...
                    Case KeyPencarian.Transaksi_DO_BON_Perwakilan_PO
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN,B.KODE,B.NAMA,A.KOLI-A.KOLI_T AS KOLI,A.QUANTITY-A.QUANTITY_T AS QTY,A.SATUAN,A.PCS-A.PCS_T AS PCS FROM V_D_DB_PERW_T_PO A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND A.ST=0 ORDER BY URUTAN")
                            LoadDataToGrid.Init("No.", 15)
                            LoadDataToGrid.Init("Kode Barang", 50)
                            LoadDataToGrid.Init("Nama Barang", 150)
                            LoadDataToGrid.Init("Koli", 40, DevExpress.Utils.FormatType.Numeric, "n")
                    ...
                    Case KeyPencarian.Transaksi_Transfer_Barang_Retur
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT ID_TTB,NO_TTB,B.KODE,B.NAMA,A.KOLI-A.KOLI_T,A.QUANTITY-A.QUANTITY_T,A.PCS-A.PCS_T FROM V_D_TRANSFER_T_TERIMA_RETUR A WITH (NOLOCK) LEFT JOIN BARANG B WITH (NOLOCK) ON A.ID_BARANG=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' AND ST=0 ORDER BY URUTAN")
                ...
                'AR
                    Case KeyPencarian.Transaksi_Create_DSR
                        Using LoadDataToGrid As New _LoadDataToGrid
                            LoadDataToGrid.BeginInit("SELECT A.URUTAN, A.NO_NOTA, A.NO_DO, B.NAMA, A.BRUTO, A.STD_DISC, A.ADD_DISC, A.CASH_DISC, A.NETTO FROM AR_DSR_DETAIL A WITH (NOLOCK) JOIN CUSTOMER B WITH (NOLOCK) ON A.ID_CUSTOMER=B.ID WHERE A.ID_TRANSAKSI='" & GridView1.GetFocusedRow(0) & "' ORDER BY A.URUTAN")
                            LoadDataToGrid.Init("No.", 15)
    ...
    Private Sub Proses()
        ...
        Select Case Key
            Case KeyPencarian.Transaksi_Purchase_Order
                Using LoadDataToGrid As New _LoadDataToGrid
                    LoadDataToGrid.BeginInit("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_PO,A.TGL,A.TGL_PENGAKUAN,C.NAMA,A.DPP+A.PPN AS TOTAL FROM PURCHASE_ORDER A WITH (NOLOCK) INNER JOIN V_D_PO_T_DO B WITH (NOLOCK) ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN DIVISI C ON A.DIVISI=C.KODE LEFT JOIN LINK_USER_DIVISI D ON A.DIVISI=D.KODE_DIVISI WHERE A.BATAL=0 AND B.STK=0 AND D.ID_USER='" & UserID & "' " & IIf(EnumDescription(Bagian).Contains("Langganan"), " AND A.BAGIAN LIKE '%Langganan%' ", " AND A.BAGIAN LIKE '%Supermarket%' ") & " ORDER BY A.TGL_PENGAKUAN")
            ...
            Case KeyPencarian.Transaksi_Nota_Penjualan_Untuk_Pembelian
                TBCari.DataSource = SelectCon.execute("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_NOTA,A.ID_DO,A.NO_DO,A.TGL_PENGAKUAN,C.NAMA,C.ALAMAT_KANTOR,DPP+PPN AS TOTAL FROM NOTA A WITH (NOLOCK) INNER JOIN V_D_NOTA_T_PEMBELIAN B WITH (NOLOCK) ON A.ID_TRANSAKSI=B.ID_NOTA LEFT JOIN CUSTOMER C ON A.KODE_CUSTOMER=C.ID LEFT JOIN LINK_USER_DIVISI D ON A.DIVISI=D.KODE_DIVISI WHERE A.BATAL=0 AND STK=0 AND D.ID_USER='" & UserID & "' AND " & IIf(EnumDescription(Bagian).Contains("Langganan"), " A.BAGIAN LIKE '%Langganan%' ", " A.BAGIAN LIKE '%Supermarket%' "))
            ...
            Case KeyPencarian.Transaksi_Nota_Pembelian
                TBCari.DataSource = SelectCon.execute("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_NOTA,B.NO_NOTA_PENJUALAN,B.TGL_PENGAKUAN,C.NAMA,C.ALAMAT,B.ALAMAT_KIRIM FROM V_D_PB_T_CLAIM A WITH (NOLOCK) INNER JOIN PEMBELIAN B WITH (NOLOCK) ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN SBU C ON B.KODE_SUPPLIER=C.KODE LEFT JOIN LINK_USER_DIVISI D ON B.DIVISI=D.KODE_DIVISI WHERE STK=0 AND D.ID_USER='" & UserID & "' AND " & IIf(EnumDescription(Bagian).Contains("Langganan"), " B.BAGIAN LIKE '%Langganan%' ", " B.BAGIAN LIKE '%Supermarket%' "))
                GridView1.Columns(0).Caption = "ID Nota"
                GridView1.Columns(0).Width = 50
            ...
            Case KeyPencarian.Transaksi_Nota_Perwakilan
                Using LoadDataToGrid As New _LoadDataToGrid
                    LoadDataToGrid.BeginInit("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_NOTA,A.TGL,A.TGL_PENGAKUAN,A.NO_DO,A.TGL_DO,C.NAMA  FROM NOTA A WITH (NOLOCK) INNER JOIN V_D_NOTA_T_SJ B WITH (NOLOCK) ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN CUSTOMER C WITH (NOLOCK) ON A.KODE_CUSTOMER=C.ID LEFT JOIN LINK_USER_DIVISI D ON A.DIVISI=D.KODE_DIVISI WHERE B.STK=0 AND A.BATAL=0 AND A.BAGIAN='" & EnumDescription(Bagian) & "' AND D.ID_USER='" & UserID & "'")
                    ...
                    LoadDataToGrid.Init("Tgl. D.O.", 40, DevExpress.Utils.FormatType.DateTime, "dd/MM/yyyy")
            ...
            Case KeyPencarian.Transaksi_Stuffing
                BtnClosing.Visible = True
                Using LoadDataToGrid As New _LoadDataToGrid
                    LoadDataToGrid.BeginInit("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_STUFFING,A.TGL,A.TGL_PENGAKUAN,A.NO_DO,A.TGL_DO,C.NAMA,A.ALAMAT_KIRIM FROM STUFFING A WITH (NOLOCK) INNER JOIN V_D_STUFF_T_NOTA B WITH (NOLOCK) ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN CUSTOMER C ON A.KODE_CUSTOMER=C.ID LEFT JOIN LINK_USER_DIVISI D ON A.DIVISI=D.KODE_DIVISI WHERE D.ID_USER='" & UserID & "' AND BATAL=0 AND NOT EXISTS (SELECT * FROM CLOSING_TRANSAKSI WHERE A.ID_TRANSAKSI=ID_TRANSAKSI) AND B.STK=0 AND A.BATAL=0 AND A.BAGIAN='" & EnumDescription(Bagian) & "' ORDER BY 3")
            ...
            Case KeyPencarian.Transaksi_DO_BON_Pusat
                BtnClosing.Visible = True
                TBCari.DataSource = SelectCon.execute("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_DO,A.TGL,A.TGL_PENGAKUAN,C.NAMA,A.TOTAL FROM (SELECT DELIVERY_ORDER.ID_TRANSAKSI,NO_DO,DELIVERY_ORDER.TGL,TGL_PENGAKUAN,DELIVERY_ORDER.KODE_CUSTOMER,DPP+PPN AS TOTAL,BAGIAN FROM DELIVERY_ORDER WITH (NOLOCK) LEFT JOIN VI_PAY_KONTAN WITH (NOLOCK) ON DELIVERY_ORDER.ID_TRANSAKSI=VI_PAY_KONTAN.ID_TRANSAKSI LEFT JOIN LINK_USER_DIVISI Z ON DELIVERY_ORDER.DIVISI=Z.KODE_DIVISI WHERE  Z.ID_USER='" & UserID & "' AND DELIVERY_ORDER.BATAL=0 AND (VI_PAY_KONTAN.STATUS_LUNAS=1 OR VI_PAY_KONTAN.STATUS_LUNAS IS NULL) UNION ALL SELECT ID_TRANSAKSI,NO_BON,BON_PESANAN.TGL,TGL_PENGAKUAN,KODE_CUSTOMER,DPP+PPN AS TOTAL,BAGIAN FROM BON_PESANAN LEFT JOIN LINK_USER_DIVISI X ON BON_PESANAN.DIVISI=X.KODE_DIVISI WHERE X.ID_USER='" & UserID & "' AND BON_PESANAN.BATAL=0) A INNER JOIN V_D_DB_PUSAT_T_NOTA B ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN CUSTOMER C ON A.KODE_CUSTOMER=C.ID WHERE B.STK=0 AND NOT EXISTS (SELECT * FROM CLOSING_TRANSAKSI WHERE A.ID_TRANSAKSI=ID_TRANSAKSI) AND A.BAGIAN='" & EnumDescription(Bagian) & "' ORDER BY A.TGL")
                GridView1.Columns(0).Caption = "ID Transaksi"
                GridView1.Columns(0).Width = 50
                GridView1.Columns(0).Visible = False
                GridView1.Columns(1).Caption = "No. DO"
            ...
            Case KeyPencarian.Transaksi_Nota_Refund
                TBCari.DataSource = SelectCon.execute("SELECT A.ID_TRANSAKSI, A.NO_NOTA, A.TGL, A.TGL_PENGAKUAN, B.NAMA, B.ALAMAT_KANTOR, A.ALAMAT_KIRIM FROM NOTA A WITH (NOLOCK) LEFT JOIN CUSTOMER B WITH (NOLOCK) ON A.KODE_CUSTOMER=B.ID WHERE A.BATAL=0 AND BAGIAN LIKE '%Supermarket%'")
                GridView1.Columns(0).Caption = "ID Nota"
                GridView1.Columns(0).Width = 50
                GridView1.Columns(0).Visible = False
                GridView1.Columns(1).Caption = "No. Nota"
            ...
            Case KeyPencarian.Transaksi_TTB
                Using LoadDataToGrid As New _LoadDataToGrid
                    LoadDataToGrid.BeginInit("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_NOTA,A.TGL_PENGAKUAN,C.NAMA,D.NAMA,D.ALAMAT_KANTOR FROM TTB A WITH (NOLOCK) INNER JOIN V_D_TTB_T_RJ B ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN DIVISI C WITH (NOLOCK) ON A.DIVISI=C.KODE LEFT JOIN CUSTOMER D WITH (NOLOCK) ON A.KODE_CUSTOMER=D.ID WHERE B.STK=0 AND A.BATAL=0")
                    LoadDataToGrid.Init("ID TTB", 25, , , False)
                    LoadDataToGrid.Init("No. TTB", 50)
                    LoadDataToGrid.Init("Tgl TTB", 45, DevExpress.Utils.FormatType.DateTime, "dd/MM/yyyy")
                    LoadDataToGrid.Init("Divisi", 25)
                    LoadDataToGrid.Init("Customer", 40, DevExpress.Utils.FormatType.DateTime)
                    LoadDataToGrid.Init("Alamat Customer", 50)
                    LoadDataToGrid.EndInit(TBCari, GridView1)
                    GridView1.BestFitColumns()
                    GridView1.Columns(1).BestFit()
            ...
            Case KeyPencarian.Transaksi_Titip_Barang
                TBCari.DataSource = SelectCon.execute("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_TITIP,A.TGL_PENGAKUAN,A.NO_NOTA,A.TGL_NOTA,C.NAMA,A.ALAMAT_KIRIM FROM TITIP_BARANG A WITH (NOLOCK) INNER JOIN V_D_TITIP_T_SJ B WITH (NOLOCK) ON A.ID_TRANSAKSI=B.ID_TRANSAKSI LEFT JOIN CUSTOMER C WITH (NOLOCK) ON A.KODE_CUSTOMER=C.ID WHERE A.BATAL=0 AND B.STK=0 ORDER BY A.TGL_PENGAKUAN")
            ...
            Case KeyPencarian.Transaksi_Transfer_Gudang
                TBCari.DataSource = SelectCon.execute("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_TRANSFER,A.TGL_PENGAKUAN,B.NAMA FROM V_D_TRANSFER_T_TERIMA A WITH (NOLOCK) LEFT JOIN TRANSFER_GUDANG C WITH (NOLOCK) ON A.ID_TRANSAKSI=C.ID_TRANSAKSI LEFT JOIN DIVISI B WITH (NOLOCK) ON A.DIVISI=B.KODE LEFT JOIN LINK_USER_DIVISI D WITH (NOLOCK) ON D.KODE_DIVISI=C.DIVISI WHERE A.STK=0 AND BATAL=0 AND D.ID_USER='" & UserID & "'")
            ...
            Case KeyPencarian.Transaksi_Transfer_Barang_Retur
                Using LoadDataToGrid As New _LoadDataToGrid
                    LoadDataToGrid.BeginInit("SELECT DISTINCT A.ID_TRANSAKSI,A.NO_TRANSAKSI,A.TGL_PENGAKUAN,B.NAMA,C.NAMA_GUDANG,D.NAMA_GUDANG FROM TRANSFER_BARANG_RETUR A INNER JOIN V_D_TRANSFER_T_TERIMA_RETUR AB ON A.ID_TRANSAKSI=AB.ID_TRANSAKSI LEFT JOIN DIVISI B WITH (NOLOCK) ON A.DIVISI=B.KODE LEFT JOIN GUDANG C WITH (NOLOCK) ON A.GUDANG_SUMBER=C.KODE LEFT JOIN GUDANG D WITH (NOLOCK) ON A.GUDANG_TUJUAN=D.KODE LEFT JOIN LINK_USER_DIVISI E WITH (NOLOCK) ON A.DIVISI=E.KODE_DIVISI WHERE AB.STK=0 AND E.ID_USER='" & UserID & "' AND A.BATAL=0" & IIf(ParamKode <> "", " AND A.DIVISI = '" & ParamKode & "'", ""))
...
keluar:
    ...
    Private Sub BtnClosing_Click(sender As System.Object, e As System.EventArgs) Handles BtnClosing.Click
        ...
        If MsgBox("Apakah anda yakin closing nomor " & NoTransaksi & " ?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then Exit Sub
        Using SQLServer As New SQLServerTransaction
            SQLServer.InitTransaction()
            'Header
            If SQLServer.InsertHeader({ToObject(IdTransaksi), ToObject(NoTransaksi), UserID, ToSyntax("CURRENT_TIMESTAMP")}, "CLOSING_TRANSAKSI") = False Then Exit Sub
            Log.Insert(Me, IdTransaksi)
            SQLServer.EndTransaction()

            Log.Closing(Me, IdTransaksi)
