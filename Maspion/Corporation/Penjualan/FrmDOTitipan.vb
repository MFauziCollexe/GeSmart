...
#Region "Edit"
    ...
    Private Function Restrict() As Boolean
        Using dtcek = SelectCon.execute("SELECT * FROM BON_PESANAN WHERE ID_DO='" & TxtIDTransaksi.Text & "' AND NO_DO='" & TxtNoTransaksi.Text & "' AND BATAL=0")
            If dtcek.Rows.Count > 0 Then
                MessageBox.Show("Bon Pesanan(Titipan) dari transaksi ini telah keluar." & vbCrLf &
