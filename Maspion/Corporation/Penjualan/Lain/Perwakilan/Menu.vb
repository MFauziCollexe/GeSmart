Public Class MenuDeliveryOrderLainPerwakilan
    ...
    Private Sub GetData()
        ...
        On a.ID_TRANSAKSI=st.ID_TRANSAKSI) join LINK_USER_DIVISI lud WITH (NOLOCK) on a.DIVISI=lud.KODE_DIVISI where a.BAGIAN='Lain Perwakilan' AND a.JENIS_DO='Ada Barang' AND a.PERIODE='" & periode & "' and lud.ID_USER='" & UserID & "' order by a.TGL,a.ID_TRANSAKSI")
