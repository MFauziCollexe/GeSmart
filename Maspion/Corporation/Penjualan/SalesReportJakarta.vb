Public Class InputSalesReportJakarta
    Inherits FrmSalesReportJakarta

    Private Sub InputPreDOSuper_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Text = "Input Sales Report Jakarta"
        LblTitle.Caption = "Sales Report Jakarta"
