...
#Region "Shared Sub"
    ...
    Protected Sub Simpan(sender As Object, e As System.EventArgs)
        ...
        Using SQLServer As New SQLServerTransaction
            ...
            'Header
            If SQLServer.InsertHeader({TxtIDTransaksi, TxtNoTransaksi, TglTransaksi, TglPengakuan, CmbJenis, TxtNoRef, ToSyntax("NULL"), ToSyntax("NULL"), txtKeteranganInternal, txtKeterangan, periode, UserID, ToSyntax("CURRENT_TIMESTAMP"), ToSyntax("NULL"), ToSyntax("NULL"), 0}, "AR_JURNAL") = False Then Exit Sub
            'Detail
    ...
    Protected Sub GetData()
        If TxtIDTransaksi.Text <> "" Then
            ...
            LoadData.GetData("SELECT NO_JURNAL, TGL, TGL_PENGAKUAN, JENIS, NO_REF, KETERANGAN_INTERNAL, KETERANGAN_CETAK FROM AR_JURNAL WHERE ID_JURNAL='" & TxtIDTransaksi.Text & "'")
            LoadData.SetData({TxtNoTransaksi, TglTransaksi, TglPengakuan, CmbJenis, TxtNoRef, txtKeteranganInternal, txtKeterangan})
    ...
    Protected Sub SimpanEdit(sender As Object, e As System.EventArgs)
        ...
        Using SQLServer As New SQLServerTransaction
            SQLServer.InitTransaction()
            'Header
            If SQLServer.UpdateHeader("NO_JURNAL, TGL, TGL_PENGAKUAN, JENIS, NO_REF, KETERANGAN_INTERNAL, KETERANGAN_CETAK ,MDUSER ,MDTIME", {TxtNoTransaksi, TglTransaksi, TglPengakuan, CmbJenis, TxtNoRef, txtKeteranganInternal, txtKeterangan, ToSyntax(UserID), ToSyntax("CURRENT_TIMESTAMP")}, "AR_JURNAL", "ID_JURNAL='" & TxtIDTransaksi.Text & "'") = False Then Exit Sub
            'Detail
